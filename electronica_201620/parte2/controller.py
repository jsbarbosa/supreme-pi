...
class potentiometer:
    def __init__(self, pins, v_max = 0.85234163640247829, v_min = -0.019138084047975096):
    ...
    def set_to(self, voltage):
        w1 = 100*(voltage - self.v_min)/(self.v_max - self.v_min)
        w2 = int(np.around(w1, decimals = 0))
        print(w1, w2)
        self.change(w2)
